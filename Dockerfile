...
MAINTAINER Luke Nyhof<luke.nyhof@gmail.com>

## The Geoserver version - was 2.13.0
...
ARG MAXIMUM_MEMORY="64G"

## Initial Memory that Java can allocate
ARG INITIAL_MEMORY="16G"
...
RUN set -e \
    ...
    apt-get install -y fonts-cantarell lmodern ttf-aenigma ttf-georgewilliams ttf-bitstream-vera ttf-sjfonts tv-fonts \
        build-essential libapr1-dev libssl-dev default-jdk gcc \
